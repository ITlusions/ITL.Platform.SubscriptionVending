"""Azure Storage Queue client — enqueue and worker helpers.
...
def _get_queue_client(
    ...
    *,
    ...
    url = f"https://{account_name}.queue.core.windows.net/{queue_name}"
...
def enqueue_job(
    ...
    *,
    ...
    # Storage Queue messages must be base64-encoded when using the SDK default
